...
import proxypool.setting

from asyncio import TimeoutError


class ValidityTester(object):
    test_api = proxypool.setting.TEST_API
        ...
        try:
            async with aiohttp.ClientSession() as session:
                try:
                    ...
                    print('Testing', proxy)
                    async with session.get(self.test_api, proxy=real_proxy, timeout=proxypool.setting.get_proxy_timeout) as response:
...
class Schedule(object):
    ...
    @staticmethod
    def check_pool(lower_threshold=proxypool.setting.POOL_LOWER_THRESHOLD,
                   upper_threshold=proxypool.setting.POOL_UPPER_THRESHOLD,
                   cycle=proxypool.setting.POOL_LEN_CHECK_CYCLE):
        """
